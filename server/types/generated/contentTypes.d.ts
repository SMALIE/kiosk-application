...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    scraped: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
...
export interface ApiFlagFlag extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::flag.flag'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiSocialMediaSocialMedia extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    links: Schema.Attribute.Component<'shared.social-links', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiWifiWifi extends Struct.SingleTypeSchema {
  collectionName: 'wifi';
  info: {
    description: '';
    displayName: 'Wi-Fi';
  ...
  attributes: {
    ...
    enabled: Schema.Attribute.Boolean &
      ...
      Schema.Attribute.DefaultTo<true>;
    encryption: Schema.Attribute.Enumeration<['nopass', 'WEP', 'WPA']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }> &
      Schema.Attribute.DefaultTo<'WPA'>;
    icon: Schema.Attribute.JSON &
      Schema.Attribute.Required &
      Schema.Attribute.CustomField<'plugin::strapi-plugin-iconhub.iconhub'> &
      Schema.Attribute.SetPluginOptions<{
    ...
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::wifi.wifi'>;
    ...
    ssidPlaceholder: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
